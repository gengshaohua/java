...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        node5.next = node6;
        node6.next = node7;
       /* ListNode reverse = solution.reverse1(node1);
        ListNode reverse2 = solution.reverse2(reverse);*/
        /*boolean cycle = solution.cycle(node1);*/
        /*ListNode merge = solution.merge(node1, node5);*/
        /*ListNode node = solution.removeIndex(node1, 3);*/
